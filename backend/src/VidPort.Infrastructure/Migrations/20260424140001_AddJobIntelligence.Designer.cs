...
namespace VidPort.Infrastructure.Migrations
{
    ...
    [Migration("20260424140001_AddJobIntelligence")]
    partial class AddJobIntelligence
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("VidPort.Core.Entities.JobInsight", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.ToTable("job_insights", (string)null);
                });
            ...
            modelBuilder.Entity("VidPort.Core.Entities.RawJob", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.ToTable("raw_jobs", (string)null);
                });
            ...
            modelBuilder.Entity("VidPort.Core.Entities.SkillAggregate", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<int>("WeekOverWeekChange")
                        .HasColumnType("integer")
                        .HasColumnName("week_over_week_change");

                    b.HasKey("Id");

                    b.HasIndex("SkillName", "PeriodStart")
                        .IsUnique();

                    b.ToTable("skill_aggregates", (string)null);
                });
